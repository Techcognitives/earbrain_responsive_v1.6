...
function captureEventFindAnAudiologist(name, email, zipcode) {
    ...
    var url = BASE_URL+"EventFindAnAudiologist/"+year+"/"+week+"/"+dateDDMMYY+".json";
...
function captureEventCognivuePreferred(formData) {
    ...
    var week = getCurrentWeek();
    var dateDDMMYY = getCurrentDateDDMMYYYY();
    var url = BASE_URL+"EventCognivuePreferred/"+year+"/"+week+"/"+dateDDMMYY+".json";
    var settings = {
        "url": url,
        "method": "POST",
        "headers": {
...
function captureEventOtherAudiologist(formData) {
    ...
    var week = getCurrentWeek();
    var dateDDMMYY = getCurrentDateDDMMYYYY();
    var url = BASE_URL+"EventOtherAudiologist/"+year+"/"+week+"/"+dateDDMMYY+".json";
    var settings = {
        "url": url,
        "method": "POST",
        "headers": {
...
function captureEventCanNotFindTheAUD(formData) {
    ...
    var week = getCurrentWeek();
    var dateDDMMYY = getCurrentDateDDMMYYYY();
    var url = BASE_URL+"EventCanNotFindTheAUD/"+year+"/"+week+"/"+dateDDMMYY+".json";
    var settings = {
        "url": url,
        "method": "POST",
        "headers": {
...
function captureEventPhoneNumber(formData) {
    ...
    var week = getCurrentWeek();
    var dateDDMMYY = getCurrentDateDDMMYYYY();
    var url = BASE_URL+"EventPhoneNumber/"+year+"/"+week+"/"+dateDDMMYY+".json";
    var settings = {
        "url": url,
        "method": "POST",
        "headers": {
